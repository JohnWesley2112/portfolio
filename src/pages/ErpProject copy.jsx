...
const ErpProject = () => {
    ...
    const caseStudyData = [
        ...
        //     description: "Designed an intuitive dashboard that provides administrators with a holistic view of college operations, including key metrics and quick access to all modules.",
        //     image: HomePage,
        //     features: ["Real-time metrics", "Quick navigation", "Customizable widgets", "Role-based views"],
        //     technical: ["React Context API", "Material-UI Grid", "Custom hooks", "Responsive design"]
        // },
        {
                ...
                <Grid container spacing={4} sx={{ mt: 2 }}>
                    ...
                    <Grid item xs={12} sm={3}>
                        <Box sx={{ textAlign: 'center' }}>
                            ...
                            <Typography variant="h4" sx={{ fontWeight: 'bold' }}>70%</Typography>
