...
function ErpProjectComponent() {
    return (
        ...
        >
            ...
            <Typography variant="h4" gutterBottom>ERP System</Typography>
            <Typography variant="body2" sx={{ mb: 2, color: "text.secondary" }}>
                An enterprise solution for HR, payroll, and inventory management.
            </Typography>
            <Button component={Link} to="/erp" variant="contained">
                View Case Study
            </Button>
        </Container>
    )
...
export default ErpProjectComponent
